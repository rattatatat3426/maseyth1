...
//
//	mockgen -typed -package quic -self_package github.com/rattatatat3426/maseyth1 -self_package github.com/rattatatat3426/maseyth1 -destination mock_packetconn_test.go net PacketConn
//
